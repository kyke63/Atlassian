...
public class AuthenticateLoginLogout {
	...
	public boolean logout() throws Exception {
		// New that the get operation logs us out by setting authentication cookies to:
		// LWSSO_COOKIE_KEY="" using server response header Set-Cookie
	...
	public boolean session() throws Exception {
		...
		Response response = con.httpPost(con.buildUrl("qcbin/rest/site-session"), null, map);
		boolean ret = response.getStatusCode() == HttpURLConnection.HTTP_OK;
		return ret;
