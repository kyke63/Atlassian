...
public class RestConnectorALM {
	...
	public RestConnectorALM init(Map<String, String> cookies, String serverUrl, String domain, String project) {
	...
	private RestConnectorALM() {
	}

	private static RestConnectorALM instance = new RestConnectorALM();

	public static RestConnectorALM getInstance() {
		return instance;
	}
